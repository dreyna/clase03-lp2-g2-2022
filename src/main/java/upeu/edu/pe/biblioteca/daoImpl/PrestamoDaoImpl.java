...
public class PrestamoDaoImpl implements Operaciones<Prestamo>{
	...
	public int create(Prestamo t) {
		...
		String SQL = "INSERT INTO 	prestamos (idprestamo, fecha_prestamo, fecha_devolucion, idempleados, idcliente) values("
				+ " 0, now(), ?, ?,?)";
	...
	public List<Map<String, Object>> readAll2() {
		// TODO Auto-generated method stub
		String  SQL = "select p.idprestamo, e.username as empleado, concat(c.nombres,' ',c.apellidos) as cliente from prestamos as p "
