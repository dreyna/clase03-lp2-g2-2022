...
public class DetallePrestamoDaoImpl implements Operaciones<Detalle>{
	...
	public List<Map<String, Object>> readAll2() {
		// TODO Auto-generated method stub
		String SQL = "select dp.iddetalle, dp.idprestamo, l.idlibro, l.titulo, l.autor from detalle_prestamo as dp "
				+ "inner join libros as l on dp.idlibro= l.idlibro "
				+ "inner join prestamos as p on dp.idprestamo= p.idprestamo";
